...
public class Card {
    ...
    public Card() {}
    public Card(CardType type, int number, Client client, CardColor color, LocalDate fromDate, LocalDate thruDate, int cvv) {
        this.type = type;
        this.number = number;
        this.client = client;
        this.color = color;
    ...
    public int getCvv() {
        if (cvv == 3) {
            return cvv;} else {
            System.out.println("Cvv debe contener 3 digitos");}
        return cvv;}
